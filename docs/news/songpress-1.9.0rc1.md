# Songpress 1.9.0rc1 released

Happy New Year from the Songpress team!

Today, we are releasing the Release Candidate of a new version of Songpress: **1.9.0**. The main goals of this release are:
